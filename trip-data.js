(() => {
  ...
  templates.coastToNaha = {
    ...
    subtitle: "Flipper 潛水員牛排 → 琉球村 → 美國村 → 牧志市場／國際通 → BicCamera Select／Don Quijote",
    times: [
      ...
      ["17:05–17:35", "那霸飯店入住"],
      ["17:45–18:55", "第一牧志公設市場、平和通與國際通攤商"],
    ...
    flow: [
      ...
      ["activity", "17:45–18:55", "牧志市場、平和通與國際通", "先看市場，再一路逛攤商與伴手禮店", "", "推薦：平和通小店、御菓子御殿、Blue Seal、Calbee＋、壺屋燒小物"],
    ...
    route: ["北部飯店", "Flipper 潛水員牛排", "琉球村", "美國村", "那霸飯店", "牧志市場／國際通", "BicCamera Select 國際通店", "國際通晚餐", "Don Quijote 國際通店", "那霸飯店"],
    travel: ["開車約30–40分", "開車約40–50分", "開車約25–35分", "開車約40–55分", "步行約5–15分", "步行約5–10分", "步行約5–10分", "步行約5–10分", "步行約5–15分"],
    addOns: ["潛水員牛排若候位超過 90 分鐘，改附近簡餐並保住美國村與國際通", "萬座毛改為可加；真的想看才用美國村前 45 分鐘替換，不要兩個都塞，觀覽料 ¥100", "爸爸若想看完整家電賣場，11/7 從 PARCO CITY 回那霸時改繞 Kojima×BicCamera 那霸店；國際通 Select 店面較小"],
