(() => {
  ...
  const templates = {
    ...
    departure: {
      ...
      times: [
        ...
        ["09:00", "離開那霸市區，前往機場周邊加油站"],
        ["09:30", "加滿油並保留收據，開往租車營業所"],
        ["09:45", "還車驗車、卸行李與確認費用，抓約 20–30 分鐘"],
        ["10:15", "搭租車公司接駁車前往那霸機場，抓約 15–25 分鐘"],
  ...
  templates.arrivalMotobu = {
    ...
    subtitle: "MM922 抵達 → 租車接駁／取車 → A&W → 美國村 → 本部飯店",
    times: [
      ["12:25", "MM922 抵達那霸機場；入境、領行李抓約 60–75 分鐘"],
      ["13:35", "前往租車接駁乘車處；等車與搭車到機場周邊營業所約 20–35 分鐘"],
      ["14:05", "辦租車、確認保險／ETC／兒童座椅、驗車與設定導航，抓約 30–45 分鐘"],
      ["14:45", "正式開車離開租車營業所，前往 A&W 牧港店"],
      ["15:25", "A&W 漢堡與 Root Beer 當作遲午餐"],
      ["16:30", "美國村散步、看海與提早用晚餐"],
      ["18:15", "離開美國村，夜間一路北上本部町"],
      ["19:45", "入住スマイルスマートイン沖縄美ら海，便利商店補給後休息"]
    ],
    tags: ["機場周邊取車", "A&W", "中部北上"],
    route: ["那霸機場落地", "領完行李／租車接駁", "租車營業所完成取車", "A&W 牧港店", "美國村", "スマイルスマートイン沖縄美ら海"],
    travel: ["入境＋領行李約60–75分", "等車＋接駁＋辦手續約50–75分", "開車約25–40分", "開車約15–25分", "開車約75–95分"],
    addOns: ["若 14:45 前仍未取到車，取消 A&W，直接去美國村吃飯", "若 16:30 後才到美國村，只吃飯與短停 45–60 分鐘，最晚 18:30 北上"],
    food: [["A&W 牧港店", "漢堡與 Root Beer", "取車後遲午餐主線"], ["美國村晚餐", "塔可飯／沖繩料理", "北上前提早吃"], ["ポーたま", "豬肉蛋飯糰", "機場排隊短才買"]],
    photos: [
      ["assets/aw-burger.jpg", "A&W 牧港店", "取車後先吃沖繩代表漢堡", "food"],
      ...
      ["assets/american-depot.jpg", "美國村夜景", "吃完晚餐再沿海散步", "main"]
    ],
    drive: "租車通常在那霸機場周邊營業所，不是那霸市中心；落地到真正開走建議抓 2 小時以上。第一晚最後一段仍有約 75–95 分鐘夜間車程。"
  };
  ...
  templates.churaumiLocal = {
    ...
    times: [
      ...
      ["12:30", "水族館周邊午餐"],
      ["14:00", "翡翠海灘與海洋博公園散步"],
      ["15:30", "備瀨福木林道，接著回翡翠海灘看夕色"],
      ["18:00", "牛排屋 88 美麗海店晚餐"],
      ["19:30", "回飯店休息、洗衣與整理隔天用品"]
    ],
    tags: ["水族館主線", "翡翠海灘", "短車程"],
    route: ["スマイルスマートイン沖縄美ら海", "美麗海水族館", "翡翠海灘", "備瀨福木林", "牛排屋 88 美麗海店", "本部飯店"],
    travel: ["開車約4分", "園區步行約5–10分", "開車約5分／步行約15分", "開車約5–10分", "開車約5–10分"],
  ...
  templates.kouriPineapple = {
    ...
    times: [
      ...
      ["17:00", "百年古家大家阿古豬晚餐；固定主線，需提前預約"],
      ["19:00", "Blue Seal 名護店吃冰或名護市區採買"],
      ["20:15", "返回本部飯店"]
    ],
    tags: ["蝦蝦飯主線", "鳳梨園主線", "阿古豬主線"],
    route: ["本部飯店", "古宇利大橋", "心形岩／海洋塔", "KOURI SHRIMP", "名護鳳梨園", "百年古家大家", "Blue Seal 名護店", "本部飯店"],
    travel: ["開車約30–40分", "島內開車約10–15分", "島內開車約5–10分", "開車約30–40分", "開車約10–15分", "開車約10–20分", "開車約30–40分"],
  ...
  templates.coastToNaha = {
    title: "西海岸南下、PARCO、燒肉與唐吉訶德",
    subtitle: "萬座毛 → 琉球村 → 殘波岬 → PARCO CITY → 牧志市場 → 琉球的牛 → 唐吉訶德",
    times: [
      ["08:00", "北部飯店退房，行李上車後開始南下"],
      ["09:15", "萬座毛看象鼻岩與恩納海岸"],
      ["10:30", "琉球村傳統家屋、表演與工藝"],
      ["12:30", "殘波岬短停；午餐以浜屋そば或沿線簡餐為主"],
      ["14:30", "PARCO CITY 看海、逛 UNIQLO／無印良品與採買"],
      ["17:10", "抵達那霸飯店停車、辦理入住"],
      ["17:40", "第一牧志公設市場看魚貨；最晚營業依店家為準"],
      ["19:00", "琉球的牛那霸國際通店／久茂地店晚餐；需預約"],
      ["20:45", "Don Quijote 國際通店採買藥妝與伴手禮"],
      ["22:00", "步行返回那霸飯店"]
    ],
    tags: ["PARCO CITY 主線", "琉球的牛主線", "唐吉訶德主線"],
    route: ["北部飯店", "萬座毛", "琉球村", "殘波岬", "PARCO CITY", "那霸飯店", "牧志市場", "琉球的牛那霸店", "Don Quijote 國際通店", "那霸飯店"],
    travel: ["開車約60–75分", "開車約25–35分", "開車約20–30分", "開車約50–65分", "開車約20–30分", "步行約5–15分", "步行約5–10分", "步行約5–10分", "步行約5–15分"],
    addOns: ["當天塞車或家人累時，先刪殘波岬，PARCO、牧志市場與預約晚餐優先", "BANTA CAFE 本次不再硬塞；若一定想去，就取代殘波岬與部分 PARCO 時間"],
    food: [["浜屋そば", "軟骨沖繩麵", "中部快速午餐"], ["琉球的牛 那霸店", "沖繩縣產和牛燒肉", "從第一天移到那霸住宿夜，需預約"], ["第一牧志公設市場", "海鮮與市場料理", "晚餐前先看魚貨"]],
    photos: [
      ["assets/manzamo.jpg", "萬座毛", "西海岸南下第一站", "main"],
      ["assets/parco-city.webp", "PARCO CITY", "南下回那霸途中的正式購物主線", "main"],
      ...
      ["assets/ryukyu-beef.jpg", "琉球的牛那霸店", "第一天移到那霸住宿夜的燒肉", "food"],
      ["assets/hamaya-soba.jpg", "浜屋そば", "中部沖繩麵備選", "food"],
      ["assets/banta-cafe.jpg", "BANTA CAFE", "與殘波岬二選一", "optional"]
    ],
    drive: "PARCO CITY 在浦添西海岸，放在北部南下回那霸的路上最順。停好飯店車後，牧志市場、琉球的牛與唐吉訶德改用步行，不再找市區停車位。"
  };
  ...
  templates.southFish = {
    ...
    times: [
      ...
      ["13:45", "沖繩世界與玉泉洞"],
      ["17:15", "瀨長島看夕陽"],
      ["18:15", "瀨長島海風露台晚餐；有訂位才改幸福鬆餅"],
      ["20:15", "回那霸飯店停車"],
      ["20:45", "國際通自由散步，暖暮／琉家拉麵可當宵夜"]
    ],
    tags: ["爸爸魚市場", "南部主線", "瀨長島夕陽"],
    route: ["那霸飯店", "泊いゆまち", "波上宮", "齋場御嶽", "知念岬", "奧武島", "玉泉洞", "瀨長島", "那霸飯店", "國際通"],
    travel: ["開車約10–15分", "開車約10–15分", "開車約40–55分", "開車約5分", "開車約20–30分", "開車約10分", "開車約25–35分", "開車約15–25分", "步行約5–15分"],
  ...
  const matrix = [
    ...
    { region: "那霸／南部｜首里・市場・南城・購物", rows: [
      ...
      ["景點", "瀨長島", ["main", "11/7 夕陽"]],
      ["購物", "PARCO CITY", ["main", "11/6 南下回那霸"]],
      ["購物", "Don Quijote 國際通店", ["main", "11/6 晚餐後"]],
      ["美食", "琉球的牛 那霸店", ["main", "11/6 預約晚餐"]],
