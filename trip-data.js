(() => {
  ...
  templates.coastToNaha = {
    ...
    subtitle: "Flipper 潛水員牛排 → 琉球村 → 美國村 → Hoppepan → 牧志市場／國際通 → Don Quijote",
    times: [
      ...
      ["19:15–20:20", "國際通島料理、迴轉壽司［或 久茂燒肉］"],
      ["20:30–21:50", "國際通夜景與 Don Quijote 深夜採買"],
      ["21:55–22:35", "暖暮拉麵 那霸牧志店宵夜"]
    ],
    flow: [
      ...
      ["walk", "約 5–10 分鐘", "國際通攤商 → 晚餐餐廳"],
      ["activity", "19:15–20:20", "國際通晚餐［或 久茂燒肉］", "原本這格是國際通晚餐；想吃燒肉就改訂焼肉きんぐ 那覇久茂地店"],
      ...
      ["walk", "約 5 分鐘", "Don Quijote → 暖暮拉麵 那霸牧志店"],
      ["activity", "21:55–22:35", "暖暮拉麵 那霸牧志店", "國際通第一晚的宵夜拉麵；沖繩官方店頁列牧志店營業到深夜，出發前再確認當日公告"],
      ["walk", "約 5–15 分鐘", "暖暮拉麵 → 那霸飯店"],
      ["night", "22:35–05:00", "深夜備案：Donki／一蘭／のれん街", "暖暮後若還要補買可回 Donki；一蘭 24 小時，のれん街偏大人宵夜。以步行或計程車為主。"]
    ],
    tags: ["潛水員牛排主線", "Hoppepan 順路點心", "牧志市場傍晚主線", "暖暮宵夜"],
    route: ["北部飯店", "Flipper 潛水員牛排", "琉球村", "美國村", "Hoppepan ほっぺパン", "那霸飯店", "牧志市場／國際通", "國際通晚餐", "Don Quijote 國際通店", "暖暮拉麵 那霸牧志店", "那霸飯店"],
    travel: ["開車約30–40分", "開車約40–50分", "開車約25–35分", "開車約30–45分", "開車約15–25分", "步行約5–15分", "步行約5–10分", "步行約5–10分", "步行約5分", "步行約5–15分"],
    ...
    food: [["Flipper 潛水員牛排", "名護老字號牛排", "11/6 午間固定主線，不能預約"], ["Hoppepan ほっぺパン", "浦添人氣麵包", "11/6 美國村回那霸順路，買隔天早餐／車上點心"], ["國際通晚餐［或 久茂燒肉］", "島料理／迴轉壽司／燒肉", "原本這格是國際通晚餐；想吃燒肉就改訂焼肉きんぐ 那覇久茂地店"], ["暖暮拉麵 那霸牧志店", "豚骨拉麵", "11/6 Donki 後宵夜收尾"]],
    photos: [
      ...
      ["assets/danbo-ramen.png", "暖暮拉麵", "11/6 Donki 後的宵夜拉麵", "food"],
  ...
  templates.southFish = {
    title: "魚貨早市、玉泉洞、奧武島、PARCO 與大間 BIC",
    subtitle: "泊いゆまち → 沖繩世界／玉泉洞 → 奧武島天婦羅 → PARCO CITY → Kojima×BicCamera 那霸店 → 國際通",
    times: [
      ["07:30–08:50", "泊いゆまち看魚貨與海鮮早餐"],
      ["09:40–12:20", "沖繩世界與玉泉洞"],
      ["12:35–13:20", "奧武島現炸天婦羅午餐"],
      ["14:10–16:45", "PARCO CITY 購物與休息（為了大間 BIC，從原本 18:30 縮短）"],
      ["17:15–18:35", "Kojima×BicCamera 那霸店大間電器"],
      ["19:30–21:20", "國際通第二晚散步、晚餐與最後採買／深夜 Donki 備案"]
    ],
    flow: [
      ["activity", "週六調整註記", "為了排大間 BIC", "PARCO 從原本 14:10–18:30 縮短為 14:10–16:45；國際通從 19:10 延到 19:30。魚市場、玉泉洞、奧武島沒有刪。"],
      ...
      ["activity", "14:10–16:45", "PARCO CITY 購物與休息", "先逛親子、服飾、雜貨與超市，保留體力給週六大間 BIC", "", "網紅常逛：LEGO Store、Akachan Honpo、3COINS、無印良品、UNIQLO／GU、ABC-MART、SAN-A 超市"],
      ["drive", "約 20–30 分鐘", "PARCO CITY → Kojima×BicCamera 那霸店"],
      ["activity", "17:15–18:35", "Kojima×BicCamera 那霸店", "週六正式排大間電器店，比國際通 Select 更適合爸爸認真看家電、相機、吹風機、刮鬍刀與免稅價格", "", "推薦：吹風機、刮鬍刀、耳機、相機、空氣清淨機、廚房小家電；大型電器先確認電壓與能否帶回台灣"],
      ["drive", "約 10–20 分鐘", "Kojima×BicCamera 那霸店 → 那霸飯店"],
      ["walk", "約 5–15 分鐘", "那霸飯店 → 國際通"],
      ["activity", "19:30–21:20", "國際通第二晚", "補逛第一晚沒走完的店、晚餐甜點與最後伴手禮；Don Quijote 國際通店可當凌晨補買備案，官網營業至 05:00", "", "推薦：紅芋塔、雪鹽系列、Blue Seal 周邊、Orion 啤酒零食、沖繩限定調味料"],
      ["walk", "約 5–15 分鐘", "國際通 → 那霸飯店"],
      ["night", "21:20–05:00", "深夜備案：Donki／一蘭／のれん街／ROUND1", "回飯店後想續攤再選：Donki 補買、一蘭拉麵、のれん街宵夜；ROUND1 宜野灣需計程車或未飲酒自駕。"]
    ],
    tags: ["爸爸魚市場", "玉泉洞主線", "週六大間 BIC"],
    route: ["那霸飯店", "泊いゆまち", "沖繩世界／玉泉洞", "奧武島", "PARCO CITY", "Kojima×BicCamera 那霸店", "那霸飯店", "國際通", "那霸飯店"],
    travel: ["開車約10–15分", "開車約35–50分", "開車約10–15分", "開車約40–55分", "開車約20–30分", "開車約10–20分", "步行約5–15分", "步行約5–15分"],
    addOns: ["週六改動註記：為了加入 Kojima×BicCamera 那霸店 17:15–18:35，PARCO CITY 從原本 14:10–18:30 縮短到 14:10–16:45，國際通從原本 19:10 開始延到 19:30；魚市場、玉泉洞、奧武島都沒刪", "想看夕陽才在奧武島後加瀨長島 14:00–15:00，PARCO 改成 15:30–16:45", "齋場御嶽、知念岬與波上宮全部移出主線；若特別想去，只能用其中一站替換 PARCO 的前段時間", "ASHIBINAA Outlet 與瀨長島二選一，不再同日全塞", "若爸爸不想逛電器，Kojima×BicCamera 17:15–18:35 可取消，改成 PARCO 延長或國際通提早逛"],
    ...
    photos: [
      ...
      ["assets/kojima-naha.jpg", "Kojima×BicCamera 那霸店", "週六正式排大間電器店", "main"],
    ...
    drive: "南部日只固定一個大型景點：玉泉洞。大間 BIC 排在 11/7 週六，從 PARCO 回那霸時順路接，不放週五也不放週日機場日。"
  };
  ...
  const matrix = [
    ...
    { region: "那霸／南部｜首里・市場・南城・購物", rows: [
      ...
      ["購物", "PARCO CITY", ["main", "11/7 14:10–16:45：因加週六大間 BIC，從原本 18:30 縮短"]],
      ["購物", "BicCamera Select 國際通店", ["option", "11/6 路過小補買：店小，營業到 23:00"]],
      ["購物", "Kojima×BicCamera 那霸店", ["main", "11/7 週六正式大間 BIC：17:15–18:35，營業到 21:00"]],
      ...
      ["美食", "暖暮拉麵 那霸牧志店", ["main", "11/6 Donki 後宵夜：牧志店步行可到"]],
