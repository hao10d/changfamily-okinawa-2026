(() => {
  ...
  templates.arrivalMotobu = {
    title: "抵達沖繩，來客夢、北谷燒肉後北上",
    subtitle: "MM922 抵達 → 租車接駁／取車 → 永旺夢樂城沖繩來客夢 → 美國村 → 琉球的牛北谷店 → 本部飯店",
    times: [
      ["12:25–13:35", "MM922 抵達、入境與領行李"],
      ["14:05–14:45", "租車手續、驗車、兒童座椅與導航設定"],
      ["15:30–17:00", "永旺夢樂城沖繩來客夢輕食與購物"],
      ["17:30–18:20", "美國村海邊散步"],
    ...
    flow: [
      ...
      ["activity", "14:05–14:45", "辦理租車與驗車", "確認保險、ETC、兒童座椅並設定導航"],
      ["drive", "約 35–50 分鐘", "租車營業所 → 永旺夢樂城沖繩來客夢"],
      ["activity", "15:30–17:00", "永旺夢樂城沖繩來客夢", "先吃少量輕食，再逛 AEON STYLE、DAISO、家電與專門店，保留晚餐胃口"],
      ["drive", "約 20–30 分鐘", "永旺夢樂城沖繩來客夢 → 美國村"],
      ["activity", "17:30–18:20", "美國村散步", "海邊、Depot Island 與傍晚街景"],
      ["walk", "約 5–10 分鐘", "美國村停車處 → 琉球的牛北谷店"],
    ...
    tags: ["機場周邊取車", "來客夢購物", "琉球的牛北谷店"],
    route: ["那霸機場落地", "領完行李／租車接駁", "租車營業所完成取車", "永旺夢樂城沖繩來客夢", "美國村", "琉球的牛北谷店", "スマイルスマートイン沖縄美ら海"],
    travel: ["入境＋領行李約60–75分", "等車＋接駁＋辦手續約50–75分", "開車約35–50分", "開車約20–30分", "步行約5–10分", "開車約75–95分"],
    addOns: ["若租車延誤超過 30 分鐘，來客夢縮短成遲午餐與重點採買，保留美國村及已預約的燒肉", "第一天較滿；琉球的牛建議先訂 18:30，吃完直接北上，不再增加夜間景點"],
    food: [["永旺夢樂城來客夢", "遲午餐／美食街", "取車後先墊胃"], ["琉球的牛 北谷店", "沖繩縣產和牛燒肉", "18:30 預約主線"], ["ポーたま", "豬肉蛋飯糰", "機場排隊短才買"]],
    photos: [
      ["assets/aeon-rycom.jpg", "永旺夢樂城沖繩來客夢", "第一天正式購物與晚餐主線", "main"],
      ["assets/american-village.jpg", "美國村", "晚餐前沿北上動線短暫看海", "main"],
      ...
      ["assets/american-depot.jpg", "Depot Island", "北谷燒肉前的傍晚散步", "main"]
    ],
    drive: "租車通常在那霸機場周邊營業所，不是那霸市中心；落地到真正開走建議抓 2 小時以上。第一晚約 21:30 抵達本部，若延誤就縮短來客夢，不動已預約的北谷晚餐。"
  };

  templates.churaumiLocal = {
    title: "美麗海、備瀨、名護燒肉與夜間採買",
    subtitle: "美麗海水族館 → 園區簡餐 → 翡翠海灘 → 備瀨 → 燒肉五苑 → AEON 名護",
    times: [
      ["08:30–12:00", "美麗海水族館、黑潮之海與海洋博公園"],
      ["12:10–13:00", "海洋博公園內簡餐"],
      ["13:10–14:10", "翡翠海灘散步"],
      ["14:20–15:40", "備瀨福木林道"],
      ["15:45–17:00", "回飯店休息與換裝"],
      ["17:45–19:15", "燒肉五苑 名護店晚餐"],
      ["19:30–21:00", "AEON 名護與周邊專門店採買"],
      ["21:45", "返回本部飯店"]
    ],
    flow: [
      ...
      ["walk", "約 5–10 分鐘", "園區餐廳 → 翡翠海灘"],
      ["activity", "13:10–14:10", "翡翠海灘", "看北部海色、讓小朋友放風"],
      ["walk", "約 10 分鐘", "翡翠海灘 → 備瀨福木林入口"],
      ["activity", "14:20–15:40", "備瀨福木林道", "林蔭聚落散步與拍照"],
      ["drive", "約 5 分鐘", "備瀨 → 本部飯店"],
      ["activity", "15:45–17:00", "回飯店休息", "洗澡、換裝並準備晚間外出"],
      ["drive", "約 35–45 分鐘", "本部飯店 → 燒肉五苑 名護店"],
      ["activity", "17:45–19:15", "燒肉五苑 名護店", "第一餐燒肉；平日營業至 22:30，建議訂位"],
      ["drive", "約 10–15 分鐘", "燒肉五苑 → AEON 名護"],
      ["activity", "19:30–21:00", "AEON 名護夜間採買", "UNIQLO、DAISO、超市、雜貨與 Blue Seal，可實際逛約 1.5 小時"],
      ["drive", "約 35–45 分鐘", "AEON 名護 → 本部飯店"],
      ["activity", "21:45", "回飯店休息", "第二天行程完整收尾"]
    ],
    tags: ["水族館主線", "翡翠海灘", "短車程"],
    route: ["本部飯店", "美麗海水族館", "海洋博公園簡餐", "翡翠海灘", "備瀨福木林", "本部飯店", "燒肉五苑 名護店", "AEON 名護", "本部飯店"],
    travel: ["開車約4分", "園區步行約5–10分", "園區步行約5–10分", "步行約10分", "開車約5分", "開車約35–45分", "開車約10–15分", "開車約35–45分"],
    addOns: ["AEON 還逛不夠，可改去營業至凌晨 2 點的 MEGA 唐吉訶德名護店；兩者距離不遠，但國際通也會逛唐吉，不必勉強重複", "JUNGLIA 是整日行程，不能塞進水族館這一天"],
  ...
  templates.kouriPineapple = {
    ...
    subtitle: "古宇利大橋 → 心形岩 → KOURI SHRIMP → 名護鳳梨園 → DINO → 百年古家大家",
    times: [
      ["09:10–09:30", "古宇利大橋南端看海"],
      ["09:45–11:00", "心形岩或古宇利海洋塔"],
      ["11:10–12:10", "KOURI SHRIMP 蝦蝦飯"],
      ["13:00–14:45", "名護鳳梨園"],
      ["15:00–16:20", "DINO 恐龍公園"],
      ["16:20–17:15", "御菓子御殿採買與休息"],
      ["17:30–19:00", "百年古家大家阿古豬晚餐"],
      ["19:25–20:00", "Blue Seal 名護店"],
      ["20:45", "返回本部飯店"]
    ],
    flow: [
      ...
      ["activity", "15:00–16:20", "DINO 恐龍公園", "森林步道與大型恐龍模型"],
      ["walk", "同園區", "DINO 恐龍公園 → 御菓子御殿"],
      ["activity", "16:20–17:15", "御菓子御殿採買", "紫薯塔、休息與上洗手間"],
      ["drive", "約 5–10 分鐘", "御菓子御殿 → 百年古家大家"],
      ["activity", "17:30–19:00", "百年古家大家晚餐", "阿古豬固定主線，需提前預約"],
      ["drive", "約 15–25 分鐘", "百年古家大家 → Blue Seal 名護店"],
      ["activity", "19:25–20:00", "Blue Seal 名護店", "飯後吃冰、短暫休息"],
      ["drive", "約 35–45 分鐘", "Blue Seal 名護店 → 本部飯店"],
      ["activity", "20:45", "返回飯店", "第三天夜間行程結束"]
    ],
    tags: ["蝦蝦飯主線", "鳳梨園主線", "阿古豬主線"],
    route: ["本部飯店", "古宇利大橋", "心形岩／海洋塔", "KOURI SHRIMP", "名護鳳梨園", "DINO 恐龍公園", "御菓子御殿", "百年古家大家", "Blue Seal 名護店", "本部飯店"],
    travel: ["開車約30–40分", "開車約10–15分", "開車約5–10分", "開車約30–40分", "開車約5–10分", "園區步行", "開車約5–10分", "開車約15–25分", "開車約35–45分"],
  ...
  templates.coastToNaha = {
    title: "潛水員牛排、西海岸與傍晚國際通",
    subtitle: "Flipper 潛水員牛排 → 萬座毛 → 琉球村 → 牧志市場／國際通 → Don Quijote",
    times: [
      ["09:40–10:30", "Flipper 登記候位、名護灣海邊短走"],
      ["10:30–12:00", "Flipper 潛水員牛排午餐"],
      ["12:45–13:30", "萬座毛看象鼻岩與恩納海岸"],
      ["14:00–15:30", "琉球村傳統家屋、表演與工藝"],
      ["16:40–17:10", "那霸飯店入住"],
      ["17:20–19:20", "第一牧志公設市場、平和通與國際通攤商"],
    ...
    flow: [
      ...
      ["drive", "約 35–45 分鐘", "Flipper → 萬座毛"],
      ["activity", "12:45–13:30", "萬座毛", "象鼻岩、海岸步道與展望台"],
      ["drive", "約 20–30 分鐘", "萬座毛 → 琉球村"],
      ["activity", "14:00–15:30", "琉球村", "紅瓦家屋、文化表演與工藝"],
      ["drive", "約 55–70 分鐘", "琉球村 → 那霸飯店"],
      ["activity", "16:40–17:10", "那霸飯店入住", "停車、放行李後改用步行"],
      ["walk", "約 5–15 分鐘", "那霸飯店 → 第一牧志公設市場"],
      ["activity", "17:20–19:20", "牧志市場、平和通與國際通", "先看魚貨，再一路逛攤商與伴手禮店，保留完整兩小時"],
    ...
    route: ["北部飯店", "Flipper 潛水員牛排", "萬座毛", "琉球村", "那霸飯店", "牧志市場／國際通", "國際通晚餐", "Don Quijote 國際通店", "那霸飯店"],
    travel: ["開車約30–40分", "開車約35–45分", "開車約20–30分", "開車約55–70分", "步行約5–15分", "步行約5–10分", "步行約5–10分", "步行約5–15分"],
    addOns: ["潛水員牛排不能預約，若現場預估超過 90 分鐘，改附近簡餐並保住牧志市場傍晚時段", "殘波岬改為可加點；要去就縮短琉球村約 45 分鐘，不能壓縮市場"],
    ...
    photos: [
      ...
      ["assets/market-makishi.jpg", "第一牧志公設市場", "17:20 先看魚貨與市場攤商", "main"],
      ...
      ["assets/zanpa-lighthouse.jpg", "殘波岬", "縮短琉球村才能加入", "optional"]
    ],
    drive: "潛水員牛排只做午間且週三休，因此固定排在 11/6 南下日。抵達那霸後先停車，牧志市場、國際通晚餐與唐吉訶德全部改用步行。"
  };

  templates.southFish = {
    title: "魚貨早市、南城聖地、PARCO 與國際通",
    subtitle: "泊いゆまち → 波上宮 → 齋場御嶽 → 知念岬 → 奧武島 → 玉泉洞 → 瀨長島 → PARCO CITY → 國際通",
    times: [
      ["07:30–08:40", "泊いゆまち看魚貨與海鮮早餐"],
      ["09:00–09:40", "波上宮與波之上海灘"],
      ["10:35–11:50", "齋場御嶽"],
      ["12:00–12:20", "知念岬看海"],
      ["12:50–13:30", "奧武島天婦羅午餐"],
      ["13:40–16:20", "沖繩世界與玉泉洞"],
      ["16:55–17:50", "瀨長島夕陽"],
      ["18:20–19:45", "PARCO CITY 晚餐與購物"],
      ["20:20–21:30", "國際通第二晚散步與最後採買"]
    ],
    flow: [
      ["drive", "約 10–15 分鐘", "那霸飯店 → 泊いゆまち"],
      ["activity", "07:30–08:40", "泊いゆまち魚市場", "看鮪魚、近海魚與魚貝冰台，順便吃海鮮早餐"],
      ["drive", "約 10–15 分鐘", "泊いゆまち → 波上宮"],
      ["activity", "09:00–09:40", "波上宮", "參拜與海邊神社拍照"],
      ["drive", "約 40–55 分鐘", "波上宮 → 齋場御嶽"],
      ["activity", "10:35–11:50", "齋場御嶽", "森林聖地步行"],
      ["drive", "約 5 分鐘", "齋場御嶽 → 知念岬"],
      ["activity", "12:00–12:20", "知念岬", "太平洋海景短停"],
      ["drive", "約 20–30 分鐘", "知念岬 → 奧武島"],
      ["activity", "12:50–13:30", "奧武島天婦羅", "魚、花枝與蔬菜天婦羅午餐"],
      ["drive", "約 10 分鐘", "奧武島 → 沖繩世界"],
      ["activity", "13:40–16:20", "沖繩世界與玉泉洞", "鐘乳石洞、文化王國與表演"],
      ["drive", "約 25–35 分鐘", "沖繩世界 → 瀨長島"],
      ["activity", "16:55–17:50", "瀨長島夕陽", "Umikaji Terrace 看飛機與海景"],
      ["drive", "約 20–30 分鐘", "瀨長島 → PARCO CITY"],
      ["activity", "18:20–19:45", "PARCO CITY 晚餐與購物", "先吃晚餐並逛重點店家，不把整晚都留在商場"],
      ["drive", "約 20–30 分鐘", "PARCO CITY → 那霸飯店"],
      ["walk", "約 5–15 分鐘", "那霸飯店 → 國際通"],
      ["activity", "20:20–21:30", "國際通第二晚", "補逛第一晚沒走完的店、甜點與最後伴手禮"],
      ["walk", "約 5–15 分鐘", "國際通 → 那霸飯店"]
    ],
    tags: ["爸爸魚市場", "南部主線", "瀨長島夕陽"],
    route: ["那霸飯店", "泊いゆまち", "波上宮", "齋場御嶽", "知念岬", "奧武島", "玉泉洞", "瀨長島", "PARCO CITY", "國際通", "那霸飯店"],
    travel: ["開車約10–15分", "開車約10–15分", "開車約40–55分", "開車約5分", "開車約20–30分", "開車約10分", "開車約25–35分", "開車約20–30分", "開車約20–30分", "步行約5–15分", "步行約5–15分"],
    ...
    photos: [
      ...
      ["assets/parco-city.webp", "PARCO CITY", "瀨長島後的晚餐與購物主線", "main"],
      ["assets/naha-night.jpg", "國際通第二晚", "PARCO 後回市區補逛與最後採買", "main"],
  ...
  templates.nahaToFlipper = {
    title: "那霸北上吃潛水員牛排，再走西海岸回市區",
    subtitle: "那霸 → Flipper 潛水員牛排 → 萬座毛 → 琉球村 → 牧志市場／國際通 → Don Quijote",
    times: [
      ["08:30", "從那霸飯店出發"],
    ...
    flow: [
      ...
      ["activity", "14:00–15:30", "琉球村", "紅瓦家屋、文化表演與工藝"],
      ["drive", "約 55–70 分鐘", "琉球村 → 那霸飯店"],
      ["activity", "16:40", "回飯店停車", "不用重新辦入住，這點比 C1 快一些"],
      ["walk", "約 5–15 分鐘", "那霸飯店 → 第一牧志公設市場"],
      ["activity", "16:50–19:10", "牧志市場、平和通與國際通", "比 C1 再早約 30 分鐘，保留兩小時以上逛市場與攤商"],
      ["walk", "約 5–10 分鐘", "國際通店家 → 晚餐餐廳"],
    ...
    tags: ["那霸三晚", "名護往返", "市場較早"],
    route: ["那霸飯店", "Flipper 潛水員牛排", "萬座毛", "琉球村", "那霸飯店", "牧志市場／國際通", "國際通晚餐", "Don Quijote 國際通店", "那霸飯店"],
    travel: ["開車約75–90分", "開車約35–45分", "開車約20–30分", "開車約55–70分", "步行約5–15分", "步行約5–10分", "步行約5–10分", "步行約5–15分"],
    addOns: ["C2 往返名護的車程較長，不建議再加殘波岬", "若不堅持潛水員牛排，C2 才能真正省車程；但本比較保留你指定的餐廳"],
    ...
    photos: [
      ...
      ["assets/market-makishi.jpg", "第一牧志公設市場", "16:50 先看魚貨與市場攤商", "main"],
      ["assets/manzamo.jpg", "萬座毛", "牛排後沿西海岸南下", "main"],
      ["assets/ryukyu-mura.jpg", "琉球村", "紅瓦聚落與文化表演", "main"],
      ["assets/flipper-steak.jpg", "潛水員牛排", "實際牛排餐點照片", "food"],
      ["assets/market-fish-4.jpg", "國際通市場海鮮", "傍晚市場後可選海鮮晚餐", "food"]
    ],
    drive: "C2 的好處是第三晚起連住那霸；代價是本日那霸往返名護，比 C1 約多 45–55 分鐘車程。"
  };
