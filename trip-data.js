(() => {
  ...
  templates.coastToNaha = {
    ...
    subtitle: "Flipper 潛水員牛排 → 琉球村 → 美國村 → Hoppepan → 牧志市場／國際通 → BicCamera Select／Don Quijote",
    times: [
      ...
      ["17:15–17:40", "那霸飯店入住"],
      ["17:55–18:50", "第一牧志公設市場、平和通與國際通攤商"],
      ["18:55–19:30", "BicCamera Select 那覇国際通り店，爸爸電器小採買"],
      ["19:30–20:30", "國際通島料理、迴轉壽司［或 久茂燒肉］"],
    ...
    flow: [
      ...
      ["activity", "17:55–18:50", "牧志市場、平和通與國際通", "先看市場，再一路逛攤商與伴手禮店", "", "推薦：平和通小店、御菓子御殿、Blue Seal、Calbee＋、壺屋燒小物"],
      ["walk", "約 5–10 分鐘", "國際通攤商 → BicCamera Select 那覇国際通り店"],
      ["activity", "18:55–19:30", "BicCamera Select 那覇国際通り店", "國際通上，公開營業 11:00–23:00；適合買刮鬍刀、吹風機、耳機、相機、行動電源與旅行小電器", "", "爸爸電器主線：先看小家電與免稅價格；若想看大家電，11/7 改去 Kojima×BicCamera 那霸店"],
      ["walk", "約 5–10 分鐘", "BicCamera Select → 晚餐餐廳"],
      ["activity", "19:30–20:30", "國際通晚餐［或 久茂燒肉］", "原本這格是國際通晚餐；想吃燒肉就改訂焼肉きんぐ 那覇久茂地店"],
    ...
    route: ["北部飯店", "Flipper 潛水員牛排", "琉球村", "美國村", "Hoppepan ほっぺパン", "那霸飯店", "牧志市場／國際通", "BicCamera Select 國際通店", "國際通晚餐", "Don Quijote 國際通店", "那霸飯店"],
    travel: ["開車約30–40分", "開車約40–50分", "開車約25–35分", "開車約30–45分", "開車約15–25分", "步行約5–15分", "步行約5–10分", "步行約5–10分", "步行約5–10分", "步行約5–15分"],
    addOns: ["潛水員牛排若候位超過 90 分鐘，改附近簡餐並保住美國村與國際通", "Hoppepan 週一二三休，這趟只有 11/6 週五最順；若熱門麵包售完就直接回那霸，不硬等", "萬座毛改為可加；真的想看才用美國村前 45 分鐘替換，不要兩個都塞，觀覽料 ¥100", "爸爸若想看完整家電賣場，11/7 從 PARCO CITY 回那霸時改繞 Kojima×BicCamera 那霸店；國際通 Select 店面較小"],
    ...
    photos: [
      ...
      ["assets/kojima-naha.jpg", "Kojima×BicCamera 那霸店", "若要看大電器，11/7 可替換國際通第二晚", "optional"],
  ...
  templates.southFish = {
    ...
    subtitle: "泊いゆまち → 沖繩世界／玉泉洞 → 奧武島天婦羅 → PARCO CITY → 國際通／Kojima×BicCamera 備案",
    times: [
    ...
    addOns: ["想看夕陽才在奧武島後加瀨長島 14:00–15:00，PARCO 改成 15:30–18:30", "齋場御嶽、知念岬與波上宮全部移出主線；若特別想去，只能用其中一站替換 PARCO 的前段時間", "ASHIBINAA Outlet 與瀨長島二選一，不再同日全塞", "爸爸若要看完整電器賣場，18:30 從 PARCO 改開去 Kojima×BicCamera 那霸店，19:00–20:20 採買後回飯店；那霸店公開營業 10:00–21:00"],
    ...
    photos: [
      ...
      ["assets/kojima-naha.jpg", "Kojima×BicCamera 那霸店", "爸爸想看大家電時替換國際通第二晚", "optional"],
  ...
  const matrix = [
    ...
    { region: "那霸／南部｜首里・市場・南城・購物", rows: [
      ...
      ["購物", "BicCamera Select 國際通店", ["main", "11/6 晚餐前後：小家電、相機、耳機，營業到 23:00"]],
      ["購物", "Kojima×BicCamera 那霸店", ["option", "11/7 大電器備案：替換國際通第二晚，營業到 21:00"]],
