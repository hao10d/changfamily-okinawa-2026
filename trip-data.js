(() => {
  ...
  templates.churaumiLocal = {
    ...
    flow: [
      ...
      ["activity", "08:30–12:00", "美麗海水族館", "黑潮之海、鯨鯊與海洋博公園", "單買成人 ¥2,180"],
  ...
  templates.coastToNaha = {
    ...
    flow: [
      ...
      ["activity", "12:50–14:20", "琉球村", "紅瓦家屋、文化表演與工藝", "單買成人 ¥2,000"],
  ...
  templates.southFish = {
    ...
    flow: [
      ...
      ["activity", "09:40–12:20", "沖繩世界與玉泉洞", "鐘乳石洞、文化王國與表演，今天唯一的大型景點", "單買成人 ¥2,000"],
  ...
  templates.kouriToNaha = {
    ...
    flow: [
      ...
      ["drive", "約 10–15 分鐘", "古宇利大橋 → 心形岩／古宇利海洋塔"],
      ["activity", "09:15–10:25", "心形岩或海洋塔", "長輩不走沙地階梯就改海洋塔", "心形岩免費／海洋塔成人 ¥1,000"],
      ["drive", "約 5–10 分鐘", "島內景點 → KOURI SHRIMP"],
      ["activity", "11:00–12:00", "KOURI SHRIMP 蝦蝦飯", "固定主線，開店時段先吃"],
      ["drive", "約 30–40 分鐘", "古宇利島 → 名護鳳梨園"],
      ["activity", "12:40–14:10", "名護鳳梨園", "鳳梨車、熱帶植物與伴手禮", "單買成人 ¥1,500"],
      ["drive", "約 5–10 分鐘", "名護鳳梨園 → DINO 恐龍公園"],
      ["activity", "14:20–15:30", "DINO 恐龍公園", "森林步道與大型恐龍模型", "單買成人 ¥1,000"],
  ...
  function makePassTemplate(template, attraction, ticketNote) {
    ...
    return {
      ...
      flow: template.flow.map(item => {
        ...
        return [item[0], item[1], item[2], item[3], "使用 FunPASS 美麗海四合一", item[5] || ""];
      }),
      addOns: [
