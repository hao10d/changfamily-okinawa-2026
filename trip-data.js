(() => {
  ...
  templates.arrivalMotobu = {
    title: "抵達沖繩，美國村與來客夢後北上",
    subtitle: "MM922 抵達 → 租車接駁／取車 → A&W → 美國村 → 永旺夢樂城沖繩來客夢 → 本部飯店",
    times: [
      ["12:25–13:35", "MM922 抵達、入境與領行李"],
      ["14:05–14:45", "租車手續、驗車、兒童座椅與導航設定"],
      ["15:25–16:00", "A&W 牧港店遲午餐"],
      ["16:20–17:10", "美國村散步與看海"],
      ["17:40–19:30", "永旺夢樂城沖繩來客夢逛街與晚餐"],
      ["20:50–21:20", "本部飯店入住與便利商店補給"]
    ],
    flow: [
      ...
      ["drive", "約 25–40 分鐘", "租車營業所 → A&W 牧港店"],
      ["activity", "15:25–16:00", "A&W 遲午餐", "漢堡與 Root Beer，第一餐簡單吃"],
      ["drive", "約 15–25 分鐘", "A&W 牧港店 → 美國村"],
      ["activity", "16:20–17:10", "美國村散步", "海邊、Depot Island 與夕色"],
      ["drive", "約 20–30 分鐘", "美國村 → 永旺夢樂城沖繩來客夢"],
      ["activity", "17:40–19:30", "永旺夢樂城沖繩來客夢", "約 220 間店、AEON STYLE、DAISO、家電與餐廳；在商場吃晚餐"],
      ["drive", "約 70–90 分鐘", "永旺夢樂城沖繩來客夢 → スマイルスマートイン沖縄美ら海"],
      ["activity", "20:50–21:20", "飯店入住與補給", "便利商店買水、早餐與隔天用品"]
    ],
    tags: ["機場周邊取車", "美國村", "永旺夢樂城來客夢"],
    route: ["那霸機場落地", "領完行李／租車接駁", "租車營業所完成取車", "A&W 牧港店", "美國村", "永旺夢樂城沖繩來客夢", "スマイルスマートイン沖縄美ら海"],
    travel: ["入境＋領行李約60–75分", "等車＋接駁＋辦手續約50–75分", "開車約25–40分", "開車約15–25分", "開車約20–30分", "開車約70–90分"],
    addOns: ["若租車延誤超過 30 分鐘，A&W 改外帶、美國村縮短為 30 分鐘，保留來客夢", "第一天會比較滿；來客夢專門店至 22:00、餐廳多至 23:00，但最晚 19:30 要北上，避免太晚抵達本部"],
    food: [["A&W 牧港店", "漢堡與 Root Beer", "取車後遲午餐主線"], ["永旺夢樂城來客夢", "美食街／餐廳", "第一天正式晚餐"], ["ポーたま", "豬肉蛋飯糰", "機場排隊短才買"]],
    photos: [
    ...
    drive: "租車通常在那霸機場周邊營業所，不是那霸市中心；落地到真正開走建議抓 2 小時以上。加入來客夢後，第一晚約 21:00 才到本部，若班機或租車延誤就縮短美國村。"
  };
  ...
  templates.coastToNaha = {
    ...
    subtitle: "Flipper 潛水員牛排 → 萬座毛 → 琉球村 → 牧志市場／國際通 → 琉球的牛",
    times: [
      ...
      ["16:40–17:10", "那霸飯店入住"],
      ["17:20–18:30", "第一牧志公設市場、平和通與國際通攤商"],
      ["18:45–20:15", "琉球的牛那霸店晚餐"],
      ["20:20–21:20", "國際通夜景與 Don Quijote 採買"]
    ],
    flow: [
      ...
      ["activity", "17:20–18:30", "牧志市場、平和通與國際通", "趁魚貨與小店尚未陸續收攤先逛，不把市場留到晚餐後"],
      ["walk", "約 5–10 分鐘", "牧志市場／國際通 → 琉球的牛"],
      ["activity", "18:45–20:15", "琉球的牛那霸店", "第二餐燒肉，需提前預約"],
      ["walk", "約 5–10 分鐘", "琉球的牛 → Don Quijote 國際通店"],
      ["activity", "20:20–21:20", "國際通夜景與 Don Quijote", "攤商已先逛完，晚餐後再買藥妝、零食與伴手禮"],
      ["walk", "約 5–15 分鐘", "Don Quijote → 那霸飯店"]
    ],
    tags: ["潛水員牛排主線", "牧志市場傍晚主線", "琉球的牛主線"],
    route: ["北部飯店", "Flipper 潛水員牛排", "萬座毛", "琉球村", "那霸飯店", "牧志市場／國際通", "琉球的牛那霸店", "Don Quijote 國際通店", "那霸飯店"],
    ...
    food: [["Flipper 潛水員牛排", "名護老字號牛排", "11/6 午間固定主線，不能預約"], ["琉球的牛 那霸店", "沖繩縣產和牛燒肉", "第二餐燒肉，需預約"]],
    photos: [
    ...
    drive: "潛水員牛排只做午間且週三休，因此固定排在 11/6 南下日。抵達那霸後先停車，牧志市場、國際通、琉球的牛與唐吉訶德全部改用步行。"
  };

  templates.southFish = {
    title: "魚貨早市、南城聖地、瀨長島與 PARCO",
    subtitle: "泊いゆまち → 波上宮 → 齋場御嶽 → 知念岬 → 奧武島 → 玉泉洞 → 瀨長島 → PARCO CITY",
    times: [
    ...
    flow: [
      ...
      ["activity", "18:20–20:30", "PARCO CITY 晚餐與購物", "商場營業較晚，放在市場之後的晚上最適合"],
      ["drive", "約 15–25 分鐘", "PARCO CITY → 那霸飯店"],
      ["activity", "21:00", "返回那霸飯店", "整理戰利品並準備隔天還車"]
    ],
    tags: ["爸爸魚市場", "南部主線", "瀨長島夕陽"],
    route: ["那霸飯店", "泊いゆまち", "波上宮", "齋場御嶽", "知念岬", "奧武島", "玉泉洞", "瀨長島", "PARCO CITY", "那霸飯店"],
    travel: ["開車約10–15分", "開車約10–15分", "開車約40–55分", "開車約5分", "開車約20–30分", "開車約10分", "開車約25–35分", "開車約20–30分", "開車約15–25分"],
  ...
  templates.nahaToFlipper = {
    ...
    subtitle: "那霸 → Flipper 潛水員牛排 → 萬座毛 → 琉球村 → 牧志市場／國際通 → 琉球的牛",
    times: [
      ["08:30", "從那霸飯店出發"],
      ...
      ["14:00–15:30", "琉球村"],
      ["16:40", "回那霸飯店停車"],
      ["16:50–18:20", "第一牧志公設市場、平和通與國際通"],
      ["18:40–20:10", "琉球的牛那霸店晚餐"],
      ["20:15–21:20", "國際通夜景與 Don Quijote"]
    ],
    flow: [
      ...
      ["walk", "約 5–15 分鐘", "那霸飯店 → 第一牧志公設市場"],
      ["activity", "16:50–18:20", "牧志市場、平和通與國際通", "比 C1 再早約 30 分鐘，攤商選擇較完整"],
      ["walk", "約 5–10 分鐘", "牧志市場／國際通 → 琉球的牛"],
      ["activity", "18:40–20:10", "琉球的牛那霸店", "第二餐燒肉，需提前預約"],
      ["walk", "約 5–10 分鐘", "琉球的牛 → Don Quijote 國際通店"],
      ["activity", "20:15–21:20", "國際通夜景與 Don Quijote", "攤商先逛完，晚餐後再採買"],
      ["walk", "約 5–15 分鐘", "Don Quijote → 那霸飯店"]
    ],
    tags: ["那霸三晚", "名護往返", "市場較早"],
    route: ["那霸飯店", "Flipper 潛水員牛排", "萬座毛", "琉球村", "那霸飯店", "牧志市場／國際通", "琉球的牛那霸店", "Don Quijote 國際通店", "那霸飯店"],
    ...
    food: [["Flipper 潛水員牛排", "名護老字號牛排", "從那霸北上，不能預約"], ["琉球的牛 那霸店", "沖繩縣產和牛燒肉", "需預約"]],
    photos: [
      ...
      ["assets/ryukyu-mura.jpg", "琉球村", "紅瓦聚落與文化表演", "main"],
      ["assets/flipper-steak.jpg", "潛水員牛排", "實際牛排餐點照片", "food"],
      ["assets/ryukyu-beef.jpg", "琉球的牛那霸店", "傍晚市場後的預約燒肉", "food"]
    ],
