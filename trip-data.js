(() => {
  ...
  const templates = {
    ...
    departure: {
      title: "MM925 從那霸回桃園",
      subtitle: "飯店早餐 → 那霸機場 → 13:35 起飛 → 14:20 抵達桃園",
      times: [
        ["08:00", "早餐、整理行李與退房"],
        ["10:15", "從那霸市區出發"],
        ["10:45", "抵達航廈，辦理 MM925 報到與托運"],
        ["13:35", "由那霸起飛"],
        ["14:20", "抵達桃園機場"]
      ],
      ...
      photos: [
        ...
        ["assets/naha-monorail.jpg", "那霸單軌", "前往機場的交通", "main"],
  ...
  const onna = "恩納西海岸｜萬座毛／冨著";
  const motobu = "本部／名護｜水族館／名護市區";
  const chatan = "北谷美濱｜美國村周邊";
  const ishigaki = "石垣市區｜離島碼頭／美崎町";
  const home = "溫暖的家";
