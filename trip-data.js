(() => {
  ...
  templates.churaumiLocal = {
    ...
    flow: [
      ...
      ["activity", "19:15–20:45", "AEON 名護夜間採買", "UNIQLO、DAISO、超市、雜貨與 Blue Seal，可實際逛約 1.5 小時", "", "推薦：AEON 超市買飲料水果、沖繩限定零食、隔天早餐；DAISO 補旅行小物"],
    ...
    addOns: ["想踩沙再把翡翠海灘加在午餐後，最多停 30 分鐘；不要和備瀨都拉長", "AEON 還逛不夠可改去 MEGA 唐吉訶德名護店，但國際通也會逛唐吉，不必重複"],
  ...
  templates.coastToNaha = {
    ...
    times: [
      ...
      ["20:20–21:40", "國際通夜景與 Don Quijote 採買"]
    ],
    flow: [
      ...
      ["activity", "20:20–21:40", "國際通夜景與 Don Quijote", "晚餐後再買藥妝、零食與伴手禮", "", "推薦：雪鹽、黑糖、金楚糕、沖繩泡麵、石垣島辣油、泡盛、藥妝與行李箱"],
  ...
  templates.southFish = {
    ...
    flow: [
      ...
      ["activity", "19:10–21:20", "國際通第二晚", "補逛第一晚沒走完的店、甜點與最後伴手禮", "", "推薦：紅芋塔、雪鹽系列、Blue Seal 周邊、Orion 啤酒零食、沖繩限定調味料"],
  ...
  templates.nahaToFlipper = {
    ...
    times: [
      ...
      ["20:15–21:30", "國際通夜景與 Don Quijote"]
    ],
    flow: [
      ...
      ["walk", "約 5–10 分鐘", "晚餐餐廳 → Don Quijote 國際通店"],
      ["activity", "20:15–21:30", "國際通夜景與 Don Quijote", "攤商先逛完，晚餐後再採買", "", "推薦：雪鹽、黑糖、金楚糕、沖繩泡麵、石垣島辣油、泡盛、藥妝與行李箱"],
      ["walk", "約 5–15 分鐘", "Don Quijote → 那霸飯店"]
    ],
  ...
  const matrix = [
    { region: "北部｜本部・名護・古宇利", rows: [
      ...
      ["購物", "MEGA 唐吉訶德名護店", ["option", "AEON 逛不夠再加：深夜補零食藥妝"]],
    ...
    { region: "那霸／南部｜首里・市場・南城・購物", rows: [
      ...
      ["購物", "Don Quijote 國際通店", ["main", "11/6 國際通第一晚：雪鹽、黑糖、泡麵、藥妝"]],
