(() => {
  ...
  templates.arrivalMotobu = {
    ...
    times: [
      ...
      ["16:00–17:30", "永旺夢樂城沖繩來客夢輕食、Kojima×BicCamera 比價與重點購物"],
    ...
    flow: [
      ...
      ["activity", "16:00–17:30", "永旺夢樂城沖繩來客夢", "先吃輕食，再讓爸爸看 Kojima×BicCamera 來客夢店；第一天只比價與鎖定目標，不急著走完整座商場", "", "推薦：Kojima×BicCamera 看小家電與相機、CHURAON 沖繩伴手禮、寶可夢中心、GU／UNIQLO、AEON STYLE 超市"],
  ...
  templates.kouriPineapple = {
    ...
    times: [
      ...
      ["12:40–13:10", "The Sinmay 生黑糖拿鐵"],
      ["13:35–14:55", "名護鳳梨園"],
      ["15:10–16:20", "御菓子御殿、咖啡與休息時間"],
    ...
    flow: [
      ...
      ["activity", "12:40–13:10", "The Sinmay", "今歸仁人氣外帶咖啡，主打沖繩生黑糖拿鐵與生黑糖ソフト；官方 10:00–16:30、不定休，若排隊太長就略過"],
      ["drive", "約 15–25 分鐘", "The Sinmay → 名護鳳梨園"],
      ["activity", "13:35–14:55", "名護鳳梨園", "鳳梨車、熱帶植物與伴手禮", "無券成人 ¥1,500"],
      ["drive", "約 5–10 分鐘", "名護鳳梨園 → 御菓子御殿／名護休息點"],
      ["activity", "15:10–16:20", "御菓子御殿與休息", "買紫薯塔、讓小朋友休息；The Sinmay 已喝咖啡，這裡就輕鬆補伴手禮", "", "推薦：元祖紅芋塔、紅芋點心、名護鳳梨相關點心；先買不怕國際通缺貨"],
    ...
    addOns: ["心形岩沙地階梯較多，可改古宇利海洋塔；海洋塔成人 ¥1,000", "The Sinmay 不算遠，古宇利回名護途中順路；但店休不定，出發前看官方 IG／網站，沒開就直接去鳳梨園", "小朋友精神很好才用 15:10–16:20 休息時段改玩 DINO 恐龍公園；玩 DINO 就不逛御菓子御殿，DINO 成人 ¥1,000", "海膽海葡萄丼與蝦蝦飯二選一，不要為兩餐重複排隊"],
  ...
  templates.coastToNaha = {
    ...
    times: [
      ...
      ["15:00–15:55", "美國村逛街、咖啡與海邊散步"],
      ["16:35–16:55", "Hoppepan ほっぺパン 買隔天早餐麵包"],
      ["17:15–17:40", "那霸飯店入住"],
      ["17:55–19:15", "第一牧志公設市場、平和通與國際通攤商"],
      ["19:15–20:20", "暖暮拉麵 那霸牧志店晚餐［或 久茂燒肉］"],
      ["20:30–21:50", "國際通夜景與 Don Quijote 深夜採買"]
    ],
    flow: [
      ...
      ["activity", "15:00–15:55", "美國村", "把第一天刪掉的北谷散步移到今天，逛店、喝咖啡與看海一次完成"],
      ...
      ["activity", "17:55–19:15", "牧志市場、平和通與國際通", "先看市場，再一路逛攤商與伴手禮店；BicCamera Select 只當路過小補買，不作主線", "", "推薦：平和通小店、御菓子御殿、Blue Seal、Calbee＋、壺屋燒小物"],
      ["walk", "約 5–10 分鐘", "國際通攤商 → 暖暮拉麵 那霸牧志店"],
      ["activity", "19:15–20:20", "暖暮拉麵 那霸牧志店晚餐［或 久茂燒肉］", "暖暮改為國際通第一晚晚餐主選；若想吃燒肉，這格改訂焼肉きんぐ 那覇久茂地店"],
      ["walk", "約 5 分鐘", "暖暮拉麵 → Don Quijote 國際通店"],
      ["activity", "20:30–21:50", "國際通夜景與 Don Quijote", "晚餐後再買藥妝、零食與伴手禮；官網營業 09:00–翌日05:00，真的逛太晚也還能補買", "", "推薦：雪鹽、黑糖、金楚糕、沖繩泡麵、石垣島辣油、泡盛、藥妝與行李箱"],
      ["walk", "約 5–15 分鐘", "Don Quijote → 那霸飯店"],
      ["night", "21:50–05:00", "深夜備案：Donki／一蘭／のれん街", "回飯店後若還想補買可回 Donki；一蘭 24 小時，のれん街偏大人宵夜。以步行或計程車為主。"]
    ],
    ...
    addOns: ["潛水員牛排若候位超過 90 分鐘，改附近簡餐並保住美國村與國際通", "Hoppepan 週一二三休，這趟只有 11/6 週五最順；若熱門麵包售完就直接回那霸，不硬等", "萬座毛改為可加；真的想看才用美國村前 45 分鐘替換，不要兩個都塞，觀覽料 ¥100", "BicCamera 大間改排 11/7 週六 Kojima×BicCamera 那霸店；11/6 國際通 Select 只當路過小補買"],
  ...
  templates.southFish = {
    ...
    times: [
      ...
      ["14:05–15:10", "瀨長島海風露台看海、飛機與白色階梯"],
      ["15:45–16:35", "PARCO CITY 重點購物與休息"],
      ["17:05–18:05", "T Galleria Okinawa by DFS 精品免稅"],
      ["18:15–19:10", "Kojima×BicCamera 那霸店大間電器"],
      ["19:35–21:20", "國際通第二晚散步、晚餐與最後採買／深夜 Donki 備案"]
    ],
    flow: [
      ["activity", "週六南部動線", "瀨長島、PARCO、DFS、BIC 同日安排", "魚市場、玉泉洞、奧武島維持原本順序；午餐後先排瀨長島，再把購物集中在回那霸路線上。"],
      ...
      ["activity", "14:05–15:10", "瀨長島海風露台", "白色階梯、海景、咖啡店與飛機起降；幸福鬆餅若排隊可視現場改外帶飲料或散步拍照", "", "推薦：海風露台階梯、飛機起降視角、海景咖啡、幸福鬆餅"],
      ["drive", "約 25–35 分鐘", "瀨長島 → PARCO CITY"],
      ["activity", "15:45–16:35", "PARCO CITY 重點購物與休息", "改成重點逛親子、服飾、雜貨與超市，後段接 DFS 精品與 BIC 電器", "", "網紅常逛：LEGO Store、Akachan Honpo、3COINS、無印良品、UNIQLO／GU、ABC-MART、SAN-A 超市"],
      ["drive", "約 20–30 分鐘", "PARCO CITY → T Galleria Okinawa by DFS"],
      ["activity", "17:05–18:05", "T Galleria Okinawa by DFS", "精品、香水、美妝集中；購物時提供回程航班資料，商品依 DFS 規則於那霸機場指定櫃台提領", "", "推薦：精品包款、香水、日系美妝與保養品；高單價商品先比台灣售價"],
      ["drive", "約 5–10 分鐘", "DFS → Kojima×BicCamera 那霸店"],
      ["activity", "18:15–19:10", "Kojima×BicCamera 那霸店", "大型電器店主線，比國際通 Select 更適合看家電、相機、吹風機、刮鬍刀與免稅價格", "", "推薦：吹風機、刮鬍刀、耳機、相機、空氣清淨機、廚房小家電；大型電器先確認電壓與能否帶回台灣"],
      ["drive", "約 10–20 分鐘", "Kojima×BicCamera 那霸店 → 那霸飯店"],
      ["walk", "約 5–15 分鐘", "那霸飯店 → 國際通"],
      ["activity", "19:35–21:20", "國際通第二晚", "補逛第一晚沒走完的店、晚餐甜點與最後伴手禮；Don Quijote 國際通店可當凌晨補買備案，官網營業至 05:00", "", "推薦：紅芋塔、雪鹽系列、Blue Seal 周邊、Orion 啤酒零食、沖繩限定調味料"],
    ...
    addOns: ["瀨長島改為 11/7 主線，不再列為替換景點；幸福鬆餅依預約與現場排隊決定", "DFS 精品與美妝排在 11/7 完成，購物時提供回程 MM925 航班資料並依那霸機場提貨規則辦理", "若精品購物時間拉長，BIC 控制為重點比價；若電器需求較多，DFS 控制在 60 分鐘左右", "齋場御嶽、知念岬與波上宮移出主線；若特別想去，用其中一站替換 PARCO 前段時間", "ASHIBINAA Outlet 改為購物替換方案；想去 Outlet 時，優先替換 PARCO 或 BIC，不替換瀨長島"],
    food: [["泊いゆまち", "鮪魚與海鮮", "早上魚貨最齊"], ["奧武島天婦羅", "現炸天婦羅", "南部午餐"], ["幸福鬆餅 瀨長島店", "海景厚鬆餅", "可預約／排隊狀況決定"], ["PARCO CITY 餐廳", "商場晚餐", "選擇多且不必趕市場收攤"]],
    photos: [
      ...
      ["assets/parco-city.webp", "PARCO CITY", "瀨長島後重點購物與休息", "main"],
    ...
    drive: "南部日固定玉泉洞與瀨長島。11/7 下午先看瀨長島海景，再接 PARCO、DFS 與大間 BIC，週日機場日只保留還車與登機。"
  };
  ...
  const matrix = [
    ...
    { region: "那霸／南部｜首里・市場・南城・購物", rows: [
      ...
      ["景點", "瀨長島", ["main", "11/7 14:05–15:10：海風露台、飛機起降與幸福鬆餅可加"]],
      ["購物", "PARCO CITY", ["main", "11/7 15:45–16:35：瀨長島後重點購物"]],
      ["購物", "T Galleria Okinawa by DFS", ["main", "11/7 17:05–18:05：精品、香水、美妝，回程機場提貨"]],
      ["購物", "BicCamera Select 國際通店", ["option", "11/6 路過小補買：店小，營業到 23:00"]],
      ["購物", "Kojima×BicCamera 那霸店", ["main", "11/7 18:15–19:10：大間 BIC 電器，營業到 21:00"]],
