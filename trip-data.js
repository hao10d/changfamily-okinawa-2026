(() => {
  ...
  templates.arrivalMotobu = {
    ...
    flow: [
      ...
      ["activity", "16:00–17:30", "永旺夢樂城沖繩來客夢", "先吃輕食，再逛 AEON STYLE、DAISO 與重點店家，不急著走完整座商場"],
  ...
  templates.churaumiLocal = {
    ...
    flow: [
      ...
      ["activity", "08:30–12:00", "美麗海水族館", "黑潮之海、鯨鯊與海洋博公園"],
      ...
      ["activity", "19:15–20:45", "AEON 名護夜間採買", "UNIQLO、DAISO、超市、雜貨與 Blue Seal，可實際逛約 1.5 小時"],
  ...
  templates.kouriPineapple = {
    ...
    addOns: ["心形岩沙地階梯較多，可改古宇利海洋塔", "小朋友精神很好才用 15:00–16:20 休息時段改玩 DINO 恐龍公園；玩 DINO 就不逛御菓子御殿", "海膽海葡萄丼與蝦蝦飯二選一，不要為兩餐重複排隊"],
  ...
  templates.coastToNaha = {
    ...
    flow: [
      ...
      ["activity", "12:50–14:20", "琉球村", "紅瓦家屋、文化表演與工藝"],
      ...
      ["activity", "17:45–19:20", "牧志市場、平和通與國際通", "先看市場，再一路逛攤商與伴手禮店"],
      ["walk", "約 5–10 分鐘", "國際通店家 → 晚餐餐廳"],
      ["activity", "19:20–20:20", "國際通晚餐", "選島料理、迴轉壽司或市場周邊海鮮，不再重複牛排與燒肉"],
      ["walk", "約 5–10 分鐘", "晚餐餐廳 → Don Quijote 國際通店"],
      ["activity", "20:20–21:40", "國際通夜景與 Don Quijote", "晚餐後再買藥妝、零食與伴手禮"],
    ...
    addOns: ["潛水員牛排若候位超過 90 分鐘，改附近簡餐並保住美國村與國際通", "萬座毛改為可加；真的想看才用美國村前 45 分鐘替換，不要兩個都塞"],
    food: [["Flipper 潛水員牛排", "名護老字號牛排", "11/6 午間固定主線，不能預約"], ["國際通晚餐", "島料理／迴轉壽司／市場海鮮", "依當天排隊選一家，不重複吃燒肉"]],
    photos: [
  ...
  templates.southFish = {
    ...
    flow: [
      ...
      ["activity", "09:40–12:20", "沖繩世界與玉泉洞", "鐘乳石洞、文化王國與表演，今天唯一的大型景點"],
      ["drive", "約 10–15 分鐘", "沖繩世界 → 奧武島"],
      ["activity", "12:35–13:20", "奧武島天婦羅", "魚、花枝、蔬菜與沖繩海藻天婦羅午餐"],
      ["drive", "約 40–55 分鐘", "奧武島 → PARCO CITY"],
      ["activity", "14:10–18:30", "PARCO CITY 購物與休息", "安排完整購物時間，中間可在咖啡店坐下休息並提早吃晚餐"],
      ["drive", "約 20–30 分鐘", "PARCO CITY → 那霸飯店"],
      ["walk", "約 5–15 分鐘", "那霸飯店 → 國際通"],
      ["activity", "19:10–21:20", "國際通第二晚", "補逛第一晚沒走完的店、甜點與最後伴手禮"],
  ...
  templates.kouriToNaha = {
    ...
    flow: [
      ...
      ["drive", "約 10–15 分鐘", "古宇利大橋 → 心形岩／古宇利海洋塔"],
      ["activity", "09:15–10:25", "心形岩或海洋塔", "長輩不走沙地階梯就改海洋塔"],
      ["drive", "約 5–10 分鐘", "島內景點 → KOURI SHRIMP"],
      ["activity", "11:00–12:00", "KOURI SHRIMP 蝦蝦飯", "固定主線，開店時段先吃"],
      ["drive", "約 30–40 分鐘", "古宇利島 → 名護鳳梨園"],
      ["activity", "12:40–14:10", "名護鳳梨園", "鳳梨車、熱帶植物與伴手禮"],
      ["drive", "約 5–10 分鐘", "名護鳳梨園 → DINO 恐龍公園"],
      ["activity", "14:20–15:30", "DINO 恐龍公園", "森林步道與大型恐龍模型"],
      ["walk", "同園區", "DINO 恐龍公園 → 御菓子御殿"],
      ["activity", "15:30–16:40", "御菓子御殿採買", "紫薯塔、休息並等百年古家晚餐時段"],
      ["drive", "約 5–10 分鐘", "御菓子御殿 → 百年古家大家"],
  ...
  templates.nahaToFlipper = {
    ...
    flow: [
      ...
      ["walk", "約 5–15 分鐘", "那霸飯店 → 第一牧志公設市場"],
      ["activity", "17:15–19:10", "牧志市場、平和通與國際通", "抵達後直接步行逛市場與攤商"],
      ["walk", "約 5–10 分鐘", "國際通店家 → 晚餐餐廳"],
      ["activity", "19:10–20:10", "國際通晚餐", "選島料理、迴轉壽司或市場周邊海鮮"],
      ["walk", "約 5–10 分鐘", "晚餐餐廳 → Don Quijote 國際通店"],
      ["activity", "20:15–21:30", "國際通夜景與 Don Quijote", "攤商先逛完，晚餐後再採買"],
      ["walk", "約 5–15 分鐘", "Don Quijote → 那霸飯店"]
    ],
    ...
    food: [["Flipper 潛水員牛排", "名護老字號牛排", "從那霸北上，不能預約"], ["國際通晚餐", "島料理／迴轉壽司／市場海鮮", "依當天排隊選一家"]],
    photos: [
  ...
  const matrix = [
    ...
    { region: "那霸／南部｜首里・市場・南城・購物", rows: [
      ...
      ["購物", "PARCO CITY", ["main", "11/7 下午完整逛"]],
      ["購物", "Don Quijote 國際通店", ["main", "11/6 國際通第一晚"]],
