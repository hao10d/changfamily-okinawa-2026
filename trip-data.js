(() => {
  ...
  const templates = {
    ...
    departure: {
      ...
      route: ["那霸飯店", "加油／租車公司", "那霸機場", "MM925", "桃園"],
      travel: ["開車約20–30分", "接駁約15–25分", "航廈內步行", "飛行約1小時45分"],
  ...
  templates.arrivalMotobu = {
    ...
    travel: ["開車約40–55分", "開車約30–40分", "開車約70–85分"],
  ...
  templates.churaumiLocal = {
    ...
    travel: ["開車約4分", "園區步行約5–10分", "開車約5分／步行約15分", "開車約5分"],
  ...
  templates.kouriPineapple = {
    ...
    route: ["本部飯店", "古宇利大橋", "心形岩／海洋塔", "KOURI SHRIMP", "名護鳳梨園", "百年古家大家", "本部飯店"],
    travel: ["開車約30–40分", "島內開車約10–15分", "島內開車約5–10分", "開車約30–40分", "開車約10–15分", "開車約30–40分"],
  ...
  templates.coastToNaha = {
    ...
    travel: ["開車約60–75分", "開車約25–35分", "開車約20–30分", "開車約55–75分", "依飯店步行約5–15分"],
  ...
  templates.southFish = {
    ...
    route: ["那霸飯店", "泊いゆまち", "波上宮", "齋場御嶽", "知念岬", "奧武島", "玉泉洞", "瀨長島", "那霸飯店"],
    travel: ["開車約10–15分", "開車約10–15分", "開車約40–55分", "開車約5分", "開車約20–30分", "開車約10分", "開車約25–35分", "開車約15–25分"],
