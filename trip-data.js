(() => {
  ...
  templates.coastToNaha = {
    ...
    flow: [
      ...
      ["night", "21:50–05:00", "深夜備案：Donki／一蘭／のれん街", "回飯店後還想出門再選：Donki 補買、一蘭 24 小時、のれん街偏大人宵夜。以步行或計程車為主。"]
    ],
    tags: ["潛水員牛排主線", "Hoppepan 順路點心", "牧志市場傍晚主線", "國際通第一晚"],
    route: ["北部飯店", "Flipper 潛水員牛排", "琉球村", "美國村", "Hoppepan ほっぺパン", "那霸飯店", "牧志市場／國際通", "國際通晚餐", "Don Quijote 國際通店", "那霸飯店"],
    travel: ["開車約30–40分", "開車約40–50分", "開車約25–35分", "開車約30–45分", "開車約15–25分", "步行約5–15分", "步行約5–10分", "步行約5–10分", "步行約5–15分"],
    ...
    food: [["Flipper 潛水員牛排", "名護老字號牛排", "11/6 午間固定主線，不能預約"], ["Hoppepan ほっぺパン", "浦添人氣麵包", "11/6 美國村回那霸順路，買隔天早餐／車上點心"], ["國際通晚餐［或 久茂燒肉］", "島料理／迴轉壽司／燒肉", "原本這格是國際通晚餐；想吃燒肉就改訂焼肉きんぐ 那覇久茂地店"]],
    photos: [
