(() => {
  ...
  templates.southFish = {
    title: "魚貨早市、玉泉洞、奧武島、PARCO、DFS 與大間 BIC",
    subtitle: "泊いゆまち → 沖繩世界／玉泉洞 → 奧武島天婦羅 → PARCO CITY → T Galleria Okinawa by DFS → Kojima×BicCamera 那霸店 → 國際通",
    times: [
      ["07:30–08:50", "泊いゆまち看魚貨與海鮮早餐"],
      ["09:40–12:20", "沖繩世界與玉泉洞"],
      ["12:35–13:20", "奧武島現炸天婦羅午餐"],
      ["14:10–16:10", "PARCO CITY 購物與休息"],
      ["16:40–17:55", "T Galleria Okinawa by DFS 精品免稅"],
      ["18:05–19:10", "Kojima×BicCamera 那霸店大間電器"],
      ["19:35–21:20", "國際通第二晚散步、晚餐與最後採買／深夜 Donki 備案"]
    ],
    flow: [
      ["activity", "週六購物動線", "PARCO、DFS、BIC 同日安排", "PARCO 先逛服飾雜貨，DFS 留給精品與美妝，BIC 放後段看電器；魚市場、玉泉洞、奧武島維持原本順序。"],
      ...
      ["activity", "14:10–16:10", "PARCO CITY 購物與休息", "先逛親子、服飾、雜貨與超市，後段接 DFS 精品與 BIC 電器", "", "網紅常逛：LEGO Store、Akachan Honpo、3COINS、無印良品、UNIQLO／GU、ABC-MART、SAN-A 超市"],
      ["drive", "約 20–30 分鐘", "PARCO CITY → T Galleria Okinawa by DFS"],
      ["activity", "16:40–17:55", "T Galleria Okinawa by DFS", "精品、香水、美妝集中；購物時提供回程航班資料，商品依 DFS 規則於那霸機場指定櫃台提領", "", "推薦：精品包款、香水、日系美妝與保養品；高單價商品先比台灣售價"],
      ["drive", "約 5–10 分鐘", "DFS → Kojima×BicCamera 那霸店"],
      ["activity", "18:05–19:10", "Kojima×BicCamera 那霸店", "大型電器店主線，比國際通 Select 更適合看家電、相機、吹風機、刮鬍刀與免稅價格", "", "推薦：吹風機、刮鬍刀、耳機、相機、空氣清淨機、廚房小家電；大型電器先確認電壓與能否帶回台灣"],
    ...
    tags: ["爸爸魚市場", "玉泉洞主線", "DFS 精品", "週六大間 BIC"],
    route: ["那霸飯店", "泊いゆまち", "沖繩世界／玉泉洞", "奧武島", "PARCO CITY", "T Galleria Okinawa by DFS", "Kojima×BicCamera 那霸店", "那霸飯店", "國際通", "那霸飯店"],
    travel: ["開車約10–15分", "開車約35–50分", "開車約10–15分", "開車約40–55分", "開車約20–30分", "開車約5–10分", "開車約10–20分", "步行約5–15分", "步行約5–15分"],
    addOns: ["DFS 精品與美妝排在 11/7 完成，購物時提供回程 MM925 航班資料並依那霸機場提貨規則辦理", "若精品購物時間拉長，BIC 控制為重點比價；若電器需求較多，DFS 控制在 60–75 分鐘", "想看夕陽才在奧武島後加瀨長島 14:00–15:00，PARCO 改成 15:30–16:10", "齋場御嶽、知念岬與波上宮移出主線；若特別想去，用其中一站替換 PARCO 前段時間", "ASHIBINAA Outlet 與瀨長島擇一替換，不與 DFS、BIC 同日加滿"],
    ...
    photos: [
      ...
      ["assets/parco-city.webp", "PARCO CITY", "下午購物與休息主線", "main"],
    ...
    drive: "南部日只固定一個大型景點：玉泉洞。購物動線排 11/7 週六下午，PARCO 接 DFS 再接大間 BIC，週日機場日只保留還車與登機。"
  };
  ...
  const matrix = [
    ...
    { region: "那霸／南部｜首里・市場・南城・購物", rows: [
      ...
      ["購物", "PARCO CITY", ["main", "11/7 14:10–16:10：後段接 DFS 精品與大間 BIC"]],
      ["購物", "T Galleria Okinawa by DFS", ["main", "11/7 16:40–17:55：精品、香水、美妝，回程機場提貨"]],
      ["購物", "BicCamera Select 國際通店", ["option", "11/6 路過小補買：店小，營業到 23:00"]],
      ["購物", "Kojima×BicCamera 那霸店", ["main", "11/7 18:05–19:10：大間 BIC 電器，營業到 21:00"]],
