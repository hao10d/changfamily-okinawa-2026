(() => {
  ...
  templates.churaumiLocal = {
    ...
    subtitle: "美麗海水族館 → 牛排 88 → 翡翠海灘 → 備瀨 → 燒肉五苑 → AEON 名護",
    times: [
      ["08:30–12:00", "美麗海水族館、黑潮之海與海洋博公園"],
      ["12:10–13:20", "牛排屋 88 美麗海店午餐"],
      ["13:30–14:30", "翡翠海灘散步"],
      ["14:40–16:00", "備瀨福木林道"],
      ["16:05–17:00", "回飯店休息與換裝"],
      ["17:45–19:15", "燒肉五苑 名護店晚餐"],
      ["19:30–20:45", "AEON 名護採買"],
      ["21:30", "返回本部飯店"]
    ],
    flow: [
      ["drive", "約 4 分鐘", "本部飯店 → 美麗海水族館"],
      ["activity", "08:30–12:00", "美麗海水族館", "黑潮之海、鯨鯊與海洋博公園"],
      ["drive", "約 5–10 分鐘", "美麗海水族館 → 牛排屋 88 美麗海店"],
      ["activity", "12:10–13:20", "牛排屋 88 午餐", "全程唯一一次牛排"],
      ["drive", "約 5–10 分鐘", "牛排屋 88 → 翡翠海灘"],
      ["activity", "13:30–14:30", "翡翠海灘", "看北部海色、讓小朋友放風"],
      ["walk", "約 10 分鐘", "翡翠海灘 → 備瀨福木林入口"],
      ["activity", "14:40–16:00", "備瀨福木林道", "林蔭聚落散步與拍照"],
      ["drive", "約 5 分鐘", "備瀨 → 本部飯店"],
      ["activity", "16:05–17:00", "回飯店休息", "洗澡、換裝並準備晚間外出"],
      ["drive", "約 35–45 分鐘", "本部飯店 → 燒肉五苑 名護店"],
      ["activity", "17:45–19:15", "燒肉五苑 名護店", "第一餐燒肉；平日營業至 22:30，建議訂位"],
      ["drive", "約 10–15 分鐘", "燒肉五苑 → AEON 名護"],
      ["activity", "19:30–20:45", "AEON 名護夜間採買", "超市、藥妝與隔天補給"],
      ["drive", "約 35–45 分鐘", "AEON 名護 → 本部飯店"],
      ["activity", "21:30", "回飯店休息", "第二天行程完整收尾"]
    ],
    tags: ["水族館主線", "翡翠海灘", "短車程"],
    route: ["本部飯店", "美麗海水族館", "牛排屋 88 美麗海店", "翡翠海灘", "備瀨福木林", "本部飯店", "燒肉五苑 名護店", "AEON 名護", "本部飯店"],
    travel: ["開車約4分", "開車約5–10分", "開車約5–10分", "步行約10分", "開車約5分", "開車約35–45分", "開車約10–15分", "開車約35–45分"],
    addOns: ["體力足夠可加熱帶夢中心，與翡翠海灘二選一", "JUNGLIA 是整日行程，不能塞進水族館這一天"],
    food: [["牛排屋 88 美麗海店", "牛排", "全程唯一一次牛排"], ["燒肉五苑 名護店", "燒肉吃到飽", "週三營業，建議提前訂位"]],
    photos: [
  ...
  templates.coastToNaha = {
    ...
    subtitle: "萬座毛 → Nakamura Soba → 琉球村 → 殘波岬 → PARCO CITY → 琉球的牛 → 唐吉訶德",
    times: [
      ["09:15–10:00", "萬座毛看象鼻岩與恩納海岸"],
      ["10:15–11:00", "Nakamura Soba 午餐"],
      ["11:30–13:30", "琉球村傳統家屋、表演與工藝"],
      ["14:00–14:40", "殘波岬燈塔與海岸"],
      ["15:40–17:40", "PARCO CITY 購物"],
      ["18:10–18:40", "那霸飯店入住"],
      ["19:00–20:30", "琉球的牛那霸店晚餐"],
      ["20:40–22:00", "Don Quijote 國際通店採買"]
    ],
    flow: [
      ["activity", "08:00", "北部飯店退房", "行李上車後開始西海岸南下"],
      ["drive", "約 60–75 分鐘", "本部飯店 → 萬座毛"],
      ["activity", "09:15–10:00", "萬座毛", "象鼻岩、海岸步道與展望台"],
      ["drive", "約 10–15 分鐘", "萬座毛 → Nakamura Soba"],
      ["activity", "10:15–11:00", "Nakamura Soba", "全程唯一一次沖繩麵"],
      ["drive", "約 20–30 分鐘", "Nakamura Soba → 琉球村"],
      ["activity", "11:30–13:30", "琉球村", "紅瓦家屋、文化表演與工藝"],
      ["drive", "約 20–30 分鐘", "琉球村 → 殘波岬"],
      ["activity", "14:00–14:40", "殘波岬", "燈塔與海岸短停"],
      ["drive", "約 50–65 分鐘", "殘波岬 → PARCO CITY"],
      ["activity", "15:40–17:40", "PARCO CITY", "看海、逛 UNIQLO／無印良品與採買"],
      ["drive", "約 20–30 分鐘", "PARCO CITY → 那霸飯店"],
      ["activity", "18:10–18:40", "那霸飯店入住", "停車、放行李後改用步行"],
      ["walk", "約 5–15 分鐘", "那霸飯店 → 琉球的牛"],
      ["activity", "19:00–20:30", "琉球的牛那霸店", "第二餐燒肉，需提前預約"],
      ["walk", "約 5–10 分鐘", "琉球的牛 → Don Quijote 國際通店"],
      ["activity", "20:40–22:00", "Don Quijote 國際通店", "藥妝、零食與伴手禮"],
      ["walk", "約 5–15 分鐘", "Don Quijote → 那霸飯店"]
    ],
    tags: ["PARCO CITY 主線", "琉球的牛主線", "唐吉訶德主線"],
    route: ["北部飯店", "萬座毛", "Nakamura Soba", "琉球村", "殘波岬", "PARCO CITY", "那霸飯店", "琉球的牛那霸店", "Don Quijote 國際通店", "那霸飯店"],
    travel: ["開車約60–75分", "開車約10–15分", "開車約20–30分", "開車約20–30分", "開車約50–65分", "開車約20–30分", "步行約5–15分", "步行約5–10分", "步行約5–15分"],
    addOns: ["當天塞車或家人累時，先刪殘波岬，PARCO 與預約晚餐優先", "BANTA CAFE 本次不再硬塞；若一定想去，就取代殘波岬與部分 PARCO 時間"],
    food: [["Nakamura Soba", "アーサ沖繩麵", "全程唯一一次沖繩麵"], ["琉球的牛 那霸店", "沖繩縣產和牛燒肉", "第二餐燒肉，需預約"]],
    photos: [
      ...
      ["assets/nakamura-soba-food.jpg", "Nakamura Soba", "全程唯一一次沖繩麵", "food"],
  ...
  templates.southFish = {
    ...
    times: [
      ...
      ["13:40–16:30", "沖繩世界與玉泉洞"],
      ["17:05–18:20", "瀨長島夕陽與晚餐"],
      ["19:30–21:00", "國際通散步與甜點採買"]
    ],
    flow: [
      ...
      ["activity", "13:40–16:30", "沖繩世界與玉泉洞", "鐘乳石洞、文化王國與表演"],
      ["drive", "約 25–35 分鐘", "沖繩世界 → 瀨長島"],
      ["activity", "17:05–18:20", "瀨長島夕陽與晚餐", "Umikaji Terrace 看飛機、海景與用餐"],
      ["drive", "約 15–25 分鐘", "瀨長島 → 那霸飯店"],
      ["activity", "18:45–19:15", "回飯店停車與休息", "放戰利品後再步行出門"],
      ["walk", "約 5–15 分鐘", "那霸飯店 → 國際通"],
      ["activity", "19:30–21:00", "國際通夜間散步", "甜點、伴手禮與街區散步，不再排牛排或沖繩麵"]
    ],
    ...
    food: [["泊いゆまち", "鮪魚與海鮮", "早上魚貨最齊"], ["奧武島天婦羅", "現炸天婦羅", "南部午餐"], ["瀨長島餐廳", "海景晚餐", "依訂位與現場排隊選擇"]],
    photos: [
  ...
  const matrix = [
    { region: "北部｜本部・名護・古宇利", rows: [
      ...
      ["美食", "牛排屋 88 美麗海店", ["main", "11/4 唯一一次牛排"]],
